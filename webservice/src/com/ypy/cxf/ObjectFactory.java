 ...
 * element interface generated in the com.ypy.cxf package.
 * <p>
...
public class ObjectFactory {
	...
	private final static QName _Say_QNAME = new QName("http://impl.cxf.ypy.com/", "say");
	private final static QName _SayResponse_QNAME = new QName("http://impl.cxf.ypy.com/", "sayResponse");

	/**
	 * Create a new ObjectFactory that can be used to create new instances of
	 * schema derived classes for package: com.ypy.cxf
	 * 
	 */
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://impl.cxf.ypy.com/", name = "say")
	 ...
	 * 
	 */
	@XmlElementDecl(namespace = "http://impl.cxf.ypy.com/", name = "sayResponse")
